...
if(isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `categories` SET `Category_name` = '$Category_name', `Available` = '$Available'  WHERE `Category_id` = '$Category_id'";

    $result         = mysqli_query($conn, $sql);

    if($result) {
        header("Location: category2.php?msg=Data Updated Successfully");
    }
    else {
