...
if(isset($_POST['submit'])) {
    ...
    $sql            = "INSERT INTO `categories` (`Category_id`, `Category_name`, `Available`) VALUES ('$Category_id', '$Category_name', '$Available')" ;

    $result         = mysqli_query($conn, $sql);

    if($result) {
        header("Location: category2.php?msg=New record created successfully");
    }
    else {
...
<body style="background: url(assets/img/library2.jpg)">
    ...
    <div class="container" style="width:50vw; min-width:300px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: #ffff; padding-top: 88px;">
        <div class="text-center mb-4">
            <h3 style="padding-top: 20px; font-family:Arial, Helvetica, sans-serif; font-weight: 300;">Add Category</h3>
        </div>
        ...
        <div class="container d-flex justify-content-center">
            <form action="" method="post">
                <div class="row">
                    ...
                    <div>
                        <label class="form-label" style="height: 2px;">Category Name</label>
                        <input type="text" class="form-control" name="Category_name">
                    </div>

                    <div>
                        <label class="form-label" style="height: 2px;">Available</label>
