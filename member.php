...
if(isset($_POST['submit'])) {
    ...
    $sql            = "INSERT INTO `members` (`Member_id`, `Name`, `Email`, `Phone`) VALUES ('$Member_id', '$Name', '$Email', '$Phone')" ;

    $result         = mysqli_query($conn, $sql);

    if($result) {
        header("Location: member2.php?msg=New record created successfully");
    }
    else {
...
<body style="background: url(assets/img/library2.jpg)">
    ...
    <div class="container" style="width:50vw; min-width:300px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: #ffff; padding-top: 88px;">
        <div class="text-center mb-4">
            <h3 style="padding-top: 20px; font-family:Arial, Helvetica, sans-serif; font-weight: 300;">Register</h3>
        </div>
