...
if(isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `books` SET `Title` = '$Title', `Author` = '$Author', `Published_year` = '$Published_year', `Publisher` = '$Publisher' WHERE `Book_id` = '$Book_id'";

    $result         = mysqli_query($conn, $sql);

    if($result) {
        header("Location: book2.php?msg=Data Updated Successfully");
    }
    else {
            ...
            <form action="" method="post">
                <div class="row">
                    ...
                    <div>
                        ...
                        value="<?php echo $row['Published_year'] ?>">
                    </div>
